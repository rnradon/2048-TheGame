  ...
  var high_score;
   ...
   function down(){
    ...
    function updateHighScore(){
      console.log("UPDATE HIGHSCORE CALLED")
      if(first_time){
    ...
    function moveKeyBoard(e) {
        ...
        if((e.keyCode === 37 || e.keyCode === 38 || e.keyCode === 39 || e.keyCode === 40) && !is2048()){
         ...
         if (e.keyCode === 37) {
              ...
              console.log("JSON.STRINGIFY OUTPUT"+JSON.stringify(mat));
        ...
        function moveClick(e){
         ...
         function reset(e) {
          ...
          fillOneRandomEmptyCell();
          redraw();
        //MARKERRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR
        document.getElementById("score").innerHTML = score;
      ...
      function retrieveOldgame(){
        mat = JSON.parse(localStorage.getItem("mat"));
        console.log("1st time refresh "+mat);
        // mat = parseInt(localStorage.getItem("mat"));
        // if(isNaN(JSON.parse(localStorage.getItem("mat"))) || typeof JSON.parse(localStorage.getItem("mat")) == 'undefined'|| JSON.parse(localStorage.getItem("mat")) == null){
        // console.log("GOING TO BE RESET");
        // console.log(isNaN(JSON.parse(localStorage.getItem("mat"))));
        if(mat == null){
          console.log("YEYYY")
          reset();
        }
         ...
         console.log("IN ELSE")
          ...
          for(i = 0; i< 4; i++){
            ...
            // console.log(i);
            // console.log(j);
            console.log("Matrix value at "+i+" "+j+" "+mat[i][j]);
            // console.log("JSON.PARSE "+JSON.parse(mat));
            // console.log("JSON.PARSE "+JSON.parse(mat[i][j]));
          }
        }
        // alert(isGameOver());
        redraw();
